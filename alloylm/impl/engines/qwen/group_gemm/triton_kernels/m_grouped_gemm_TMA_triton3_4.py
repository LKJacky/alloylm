...
def get_cuda_autotune_config():
    return [
        ...
        # Smaller configs for GPUs with limited shared memory (e.g., ~100KB/block).
        triton.Config({"BLOCK_N": 128, "BLOCK_K": 64, "GROUP_M": 6}, num_stages=3, num_warps=8),
        triton.Config({"BLOCK_N": 128, "BLOCK_K": 64, "GROUP_M": 8}, num_stages=3, num_warps=8),
        triton.Config({"BLOCK_N": 128, "BLOCK_K": 64, "GROUP_M": 10}, num_stages=3, num_warps=8),
        triton.Config({"BLOCK_N": 128, "BLOCK_K": 64, "GROUP_M": 14}, num_stages=3, num_warps=8),
        triton.Config({"BLOCK_N": 64, "BLOCK_K": 64, "GROUP_M": 6}, num_stages=4, num_warps=4),
        triton.Config({"BLOCK_N": 64, "BLOCK_K": 64, "GROUP_M": 8}, num_stages=4, num_warps=4),
        triton.Config({"BLOCK_N": 64, "BLOCK_K": 64, "GROUP_M": 10}, num_stages=4, num_warps=4),
    ]
